# Generated by Powerlevel10k configuration wizard on 2023-10-04 at 23:31 CST.
...
# vertical separators, blurred heads, blurred tails, 2 lines, solid, full frame, sparse,
...
() {
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=206
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%27F'   # green foreground (default 76)
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=27 #default 76
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=27 #default 76
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=39
  # Context color in SSH without privileges.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=51
